...
> 一款水墨古风的考研英语阅读刷题应用：**内置历年真题，手机 / 电脑下载即用，离线可刷**。
...
| 平台 | 直接下载 | 一句话说明 |
|---|---|---|
| 📱 安卓 | [kaoyan-5.12.5-android.apk](https://github.com/XDHRY/kaoyan-reading-app/releases/download/v5.12.5/kaoyan-5.12.5-android.apk) | 安装即用，**内置全部真题、完全离线**，零依赖，推荐首选 |
| 💻 Windows | [kaoyan-5.12.5-win.exe](https://github.com/XDHRY/kaoyan-reading-app/releases/download/v5.12.5/kaoyan-5.12.5-win.exe) | 便携版，双击即用（需本机已装 MySQL 8） |
| 💻 Windows | [kaoyan-5.12.5-setup.exe](https://github.com/XDHRY/kaoyan-reading-app/releases/download/v5.12.5/kaoyan-5.12.5-setup.exe) | 安装版，自动创建快捷方式（需本机已装 MySQL 8） |
...
2. **开刷真题**：打开应用 → 进「真题练习」选一篇即可，内置真题与解析**无需联网**
