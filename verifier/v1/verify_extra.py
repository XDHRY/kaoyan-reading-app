...
PASSWORD = os.environ.get("VERIFY_PASSWORD", "CHANGE_ME_USER_PASS")
passed: list[str] = []
...
def main() -> None:
    ...
    n0 = len(chs)
    r = api.mutation("channel.create", {"name": "验收测试渠道", "kind": "chat", "protocol": "openai", "baseUrl": "https://api.openai.com/v1", "apiKey": "FAKE_KEY_VERIFY_1", "models": ["gpt-test"], "isDefault": False, "personal": True})
    ...
    r2 = api.mutation("channel.update", {"id": cid, "name": "验收测试渠道-改", "protocol": "openai", "baseUrl": "https://api.openai.com/v1", "apiKey": "FAKE_KEY_VERIFY_2", "model": "gpt-test2"})
